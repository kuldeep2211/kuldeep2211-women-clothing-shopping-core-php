...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update product set p_image1='$p_image1' where p_id='$p_id' ");
...
$query=mysqli_query($con,"select p_name,p_image1 from product where p_id='$p_id'");
$cnt=1;
...
<div class="controls">
<img src="uploads/<?php echo htmlentities($row['p_image1']);?>" width="200" height="100"> 
</div>
</div>
...
<div class="controls">
<input type="file" name="p_image1" id="p_image1" value="" class="span8 tip" required>
</div>
</div>
