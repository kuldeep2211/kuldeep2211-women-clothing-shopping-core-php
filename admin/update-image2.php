...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update product set p_image2='$p_image2' where p_id='$p_id' ");
...
$query=mysqli_query($con,"select p_name,p_image2 from product where p_id='$p_id'");
$cnt=1;
...
<div class="controls">
<input type="text" name="p_name"  readonly value="<?php echo htmlentities($row['p_name']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<img src="uploads/<?php echo htmlentities($row['p_image2']);?>" width="200" height="100"> 
</div>
</div>
...
<div class="controls">
<input type="file" name="p_image2" id="p_image2" value="" class="span8 tip" required>
</div>
</div>
