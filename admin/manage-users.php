...
if(isset($_GET['del']))
{
	mysqli_query($con,"delete from user where u_id = '".$_GET['u_id']."'");
...
?>									
										<tr>
											...
											<td><a href="manage-users.php?u_id=<?php echo $row['u_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="">Delete</i></a></td>
										</tr>
