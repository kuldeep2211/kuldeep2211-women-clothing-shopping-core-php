...
<?php } ?>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
<?php 
$query=mysqli_query($con,"select feedback.*, user.fname, user.lname, user.email, user.mobileno from feedback join user on feedback.u_id = user.u_id");
$cnt=1;
...
?>									
										<tr>
											...
											<td><a href="manage-feedbacks.php?f_id=<?php echo $row['f_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="">Delete</i></a></td>
										</tr>
